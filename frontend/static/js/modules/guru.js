...
export async function runGuruAudit() {
    ...
    try {
        ...
        // Show premium dummy data if there's an error
        const a = {
            summary: "You are operating at peak alignment. Focus on strategic communication this week.",
            vibe_score: 92,
            strategic_alignment: { score: 88, assessment: "Your work consistently aligns with your long-term goal of improving system scalability.", suggestion: "Delegate minor UI fixes to focus on backend architecture." },
            code: { assessment: "great", insight: "High quality logic with minimal complexity. Test coverage is strong." },
            communication: { assessment: "good", insight: "Clear communication in PRs, but could be more concise in Slack threads." },
            efficiency: { assessment: "needs_improvement", insight: "Context switching between backend and frontend tasks is reducing deep work time." },
            wellness: { burnout_risk: "low", assessment: "good", insight: "Good balance of breaks and active coding periods." },
            cheer: "Keep up the phenomenal momentum!"
        };
